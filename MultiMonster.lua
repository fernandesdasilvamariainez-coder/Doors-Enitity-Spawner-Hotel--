wait(0.001) local function GetGitSound(GithubSnd,SoundName)
	...
	return sound
end			local JumpscareSound = GetGitSound("https://github.com/fernandesdasilvamariainez-coder/Roblox-Doors-Entities-Sounds/blob/main/MultiMonsterStart.mp3?raw=true","MultiMonsterStart") JumpscareSound.Parent = workspace
	...
	camShake:Start()
	camShake:ShakeOnce(10,10,0.1,3,1,1)
wait(0.001)
...
local entity = Creator.createEntity({
	...
	CustomDialog = {"You died to an entity designated as A-60", "It can appear at any moment, a loud scream will anounce its presence", "When you hear it spawn you must stay out of its reach as soon as possible", "It knows exactly where you are, so hiding in different places will not work..."}
})
local spawned = true
...
entity.Debug.OnEntitySpawned = function()
	...
	local function Kill()
		...
		local function DKITLS_fake_script() -- ScreenGui.Jumpscare 
			...
			JumpscareSound:Play()
			camShake:ShakeOnce(20,15,0.1,4)
			...
			DEATHMESSAGE({"You died to an entity designated as A-60.", "He can appear at any moment, a loud scream will anounce its presence.", "When you hear he spawn you must stay out of its reach as soon as possible.", "He knows exactly where you are, so hiding in different places will not work..."},"MultiMonster")
